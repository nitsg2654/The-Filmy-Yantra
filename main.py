...
def recommend():
    ...
    if(imdb_id != ""):
        ...
        req = urllib.request.Request('https://www.imdb.com/title/{}/reviews/'.format(imdb_id), headers=headers)
        sauce = urllib.request.urlopen(req, context=context).read()
        soup = bs.BeautifulSoup(sauce,'lxml')
        soup_result = soup.find_all("div",{"class":"ipc-list-card__content"})
